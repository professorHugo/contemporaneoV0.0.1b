<link rel="stylesheet" href="css/css-menu/menu.css">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li class="">
                    <a href="?acesso=Home" style="color: #fff;">
                    ...
                    <ul class="dropdown-menu forAnimate" role="menu">
                        ...
                        <li>
                            <a href="?acesso=AgendarCompartilhado" class="sub-menu" style="color:#fff">
                                <span class="glyphicon glyphicon-share"> Compartilhar Horário</span>
                            </a>
                        </li>
                        <li>
                    ...
                    <ul class="dropdown-menu forAnimate" role="menu">
                        ...
                        <li>
                            <a href="?acesso=FinalizarCadastro" class="sub-menu" style="color:#fff">
                                <span class="glyphicon glyphicon-file"> Finalizar Cadastro</span>
                            </a>
                        </li>
                        <li>
